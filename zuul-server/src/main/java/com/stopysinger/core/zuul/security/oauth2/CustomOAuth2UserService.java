...
import com.stopysinger.core.zuul.exception.OAuth2AuthenticationProcessingException;
import com.stopysinger.core.zuul.model.AuthProvider;
...
import com.stopysinger.core.zuul.security.oauth2.user.OAuth2UserInfo;
import com.stopysinger.core.zuul.security.oauth2.user.OAuth2UserInfoFactory;
